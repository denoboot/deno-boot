...
export const OakFsRouterPlugin = defineOakPlugin({
  name: "oak-fs-router",
  version: "1.0.0",
  description: "Oak FileSystemRouter plugin",
  type: 'server',
  ...
  routes: [{
    ...
    handler({ container }) {
      ...
      const root = join(Deno.cwd(), config?.outputDir || '..') // TODO: Fix this
...
export default OakFsRouterPlugin;
