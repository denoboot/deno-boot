...
import { defineBootPlugin } from "@denoboot/engine/mod.ts";
import { TenantManager } from "@denoboot/engine/tenant-manager.ts";

export const DenoKVPlugin = defineBootPlugin({
  name: "denokv",
  version: "1.0.0",
